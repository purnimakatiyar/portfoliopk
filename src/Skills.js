        ...
        <div className="row">
          <div className="col__3">
            <div className="service__box pointer">
              ...
              <div className="service__meta">
                <h1 className="service__text">C/C++</h1>
                <p className="p service__text p__color">
                  I am skilled in this language. Learnt years ago.
                  <br></br>
                  <br></br>
                  <br></br>
                </p>
          ...
          <div className="col__3">
            <div className="service__box pointer">
              ...
              <div className="service__meta">
                <h1 className="service__text">HTML, CSS, JS</h1>
                <p className="p service__text p__color">
                  I have learnt these for website making and designing, basically for frontend development.
                  <br></br>
                  <br></br>
                </p>
              </div>
          ...
          <div className="col__3">
            <div className="service__box pointer">
              ...
              <div className="service__meta">
                ...
                <p className="p service__text p__color">
                  I have learnt these for project related works.
                  <br></br>
                  <br></br>
                </p>
              </div>
